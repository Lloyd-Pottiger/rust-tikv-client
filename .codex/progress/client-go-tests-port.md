...
- `client-go/tikv/main_test.go` + `client-go/txnkv/**`(mocktikv parts): 强依赖 mocktikv cluster/PD HTTP mocks；Rust 以 `tests/integration_tests.rs`(real cluster) + unit-test mocks 覆盖等价语义
